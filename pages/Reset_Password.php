        ...
        <div class="w-11/12 h-4/6 flex justify-between bg-white rounded-md shadow-lg overflow-hidden sm:w-11/12 md:w-10/12 lg:w-8/12 xl:w-6/12 2xl:w-6/12">
            ...
            <div class="w-[800px] px-4 flex flex-col justify-center m-auto gap-2 sm:px-4 md:px-8 lg:px-8 xl:px-8 2xl:px-8">
                <header class="text-center">
                    <h2 class="font-medium text-2xl text-slate-800 py-2">Reset Password</h2>
                ...
                <form method="POST" action="../api/reset_password.php">
                    ...
                    <div class="flex flex-col gap-2 py-2">
                        <label class="text-sm font-base text-slate-800" for="new_password">New Password</label>
                        <input class="w-full p-3 border rounded text-sm" type="password" id="new_password" name="new_password" placeholder="New Password" required>
                    </div>
                    <div class="flex flex-col gap-2 py-2">
                        <label class="text-sm font-base text-slate-800" for="confirm_password">Confirm Password</label>
                        <input class="w-full p-3 border rounded text-sm" type="password" id="confirm_password" name="confirm_password" placeholder="Confirm your password" required>
                        <small class="hidden" id="error_message"></small>
                    </div>
                    
                    <div class="py-5">
                        <button type="submit" class="w-full py-2 rounded bg-blue-600 text-white font-medium hover:bg-blue-400">Reset Password</button>
                    </div>
