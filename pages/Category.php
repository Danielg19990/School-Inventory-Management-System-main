...
<head>
    ...
    <title>Category | Inventory System</title>
</head>
...
<body>
    <div class="flex min-h-screen h-auto shadow">
        ...
        <div class="hidden z-30 w-full h-screen" id="modal-product">
            <div class="w-full h-screen absolute" style="background-color: rgb(0,0,0,0.8);">
                <div class="h-full w-full flex items-center justify-center">
                    <div class="h-auto bg-white rounded-md px-5 py-2 w-11/12 sm:w-10/12 md:w-7/12 lg:w-5/12 2xl:w-3/12">
                        <form method="POST" action="../api/set_category.php" class="h-full flex flex-col justify-between">
                            ...
                            <div class="h-full w-full">
                                <div class="py-2 flex items-center gap-2 justify-between">
                                    <div class="flex flex-col gap-2 w-full">
                                        ...
                                        <input class="w-full py-2 px-3 border rounded appearance-none focus:outline-blue-300" id="category_name" name="category_name" type="text" placeholder="Enter category" required>
                                    </div>
                                </div>
                            </div>
          ...
          <div class="hidden z-30 w-full h-screen" id="modal-edit-category">
            <div class="w-full h-screen absolute" style="background-color: rgb(0,0,0,0.8);">
                <div class="h-full w-full flex items-center justify-center">
                    <div class="h-auto bg-white rounded-md px-5 py-2 w-11/12 sm:w-10/12 md:w-7/12 lg:w-5/12 2xl:w-3/12">
                        <form method="POST" action="../api/update_category.php" class="h-full flex flex-col justify-between">
                            <header class="py-5 flex items-center justify-between">
                                <div>
                            ...
                            <div class="h-full w-full">
                                <div class="py-2 flex items-center gap-2 justify-between">
                                    <div class="flex flex-col gap-2 w-full">
                                        <label for="category_edit_name" class="text-sm">Category Name</label>
                                        <input class="hidden" id="category_edit_id" name="category_edit_id" type="number" required>
                                        <input class="w-full py-2 px-3 border rounded appearance-none focus:outline-blue-300" id="category_edit_name" name="category_edit_name" type="text" placeholder="Enter position" required>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-end py-5">
        ...
        <section class="w-full h-auto">
            ...
            <div class="px-5 py-10">
                <div class="py-5">
                        <button type="button" id="openModal" class="py-2 px-5 bg-blue-600 text-white font-normal rounded-md hover:bg-blue-500">Add Category</button>
                </div>
                <?php
                    if(isset($_GET["error"])){
                ...
                <div class="relative overflow-x-auto rounded-md overflow-none shadow-sm">
                    <table class="w-full text-sm text-left whitespace-nowrap">
                        ...
                        <tbody>
                            <?php
                            include "../api/table_category.php";
                            ?>
                        </tbody>
                    </table>
                </div>
